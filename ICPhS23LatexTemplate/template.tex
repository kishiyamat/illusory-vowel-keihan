...
\author{
    Takeshi Kishiyama\thanks{Corresponding author: kishiyama.t@gmail.com
    The research was conducted in accordance with ethical requirements and it has been approved by the institution.
    We obtained informed consent from research participants.
    We conducted the research according to appropriate practices that are considered standard in psycholinguistics.
    All data and script are available at 
    https://github.com/kishiyamat/illusory-vowel-keihan .} \textrm{  }$^1$,
    Chuyu Huang$^2$,
    Kei Furukawa$^3$,
    Yuki Hirose$^1$}

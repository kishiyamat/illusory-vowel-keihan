...
posterior_interval(model,
  pars = c(
    ...
    "dev_envFALSE:stim_devoicedTRUE:tokyo_kinki_ratio"
  ),
)
```
...
for (true_false in c(TRUE, FALSE)) {
  ...
  # model_i は list に入れた段階でただの行列になってしまっていそう
  # (ので、listに格納してあとから分析、みたいな紀要なことはできない)
...
> Estimates:
                                            mean   sd   10%   50%   90%
(Intercept)                                4.5    0.2  4.3   4.5   4.7 
stim_devoicedTRUE                          0.4    0.2  0.2   0.4   0.7 
tokyo_kinki_ratio                          0.0    0.1 -0.2   0.0   0.2 
stim_devoicedTRUE:tokyo_kinki_ratio        0.0    0.1  0.0   0.0   0.1
...
>  formula:      rate ~ dev_env + stim_devoiced + tokyo_kinki_ratio + dev_env:stim_devoiced + 
> 	   dev_env:stim_devoiced:tokyo_kinki_ratio + (1 | subject_id) + 
> 	   (1 | item_id)
>  observations: 2864
> ------
>                                                   Median MAD_SD
> (Intercept)                                        4.9    0.2  
> dev_envTRUE                                       -0.4    0.2  
> stim_devoicedTRUE                                 -0.8    0.2  
> tokyo_kinki_ratio                                  0.0    0.1  
> dev_envTRUE:stim_devoicedTRUE                      1.2    0.2  
> dev_envFALSE:stim_devoicedFALSE:tokyo_kinki_ratio  0.0    0.1  
> dev_envTRUE:stim_devoicedFALSE:tokyo_kinki_ratio   0.0    0.1  
> dev_envFALSE:stim_devoicedTRUE:tokyo_kinki_ratio   0.0    0.1  
> 
...
> Error terms:
>  Groups     Name        Std.Dev.
>  subject_id (Intercept) 0.79    
>  item_id    (Intercept) 0.39    
>  Residual               1.05    
> Num. levels: subject_id 67, item_id 48 

```{r}
model_BF <- bayesfactor_parameters(model, null = c(-0.01, 0.01))
model
```
...
> (Intercept)                                       | 4.48e+30
> dev_envTRUE                                       |    0.180
> stim_devoicedTRUE                                 |   185.91
> tokyo_kinki_ratio                                 |    0.012
> dev_envTRUE:stim_devoicedTRUE                     | 1.23e+04
> dev_envFALSE:stim_devoicedFALSE:tokyo_kinki_ratio |    0.007
> dev_envTRUE:stim_devoicedFALSE:tokyo_kinki_ratio  |    0.008
> dev_envFALSE:stim_devoicedTRUE:tokyo_kinki_ratio  |    0.008
> 
> * Evidence Against The Null: [-0.010, 0.010]

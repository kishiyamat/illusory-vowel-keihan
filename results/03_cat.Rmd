...
model <- stan_lmer(
  ...
  data = results,
  prior = normal(3, 3, autoscale = FALSE),
...
> Estimates:
                                                  mean   sd   10%   50%   90%
(Intercept)                                      4.9    0.2  4.7   4.9   5.1 
dev_envTRUE                                     -0.4    0.2 -0.6  -0.4  -0.2 
stim_devoicedTRUE                               -0.8    0.2 -1.0  -0.8  -0.6 
tokyo_kinki_ratio                                0.0    0.1 -0.2   0.0   0.2 
dev_envTRUE:stim_devoicedTRUE                    1.2    0.2  0.9   1.2   1.5 
dev_envTRUE:tokyo_kinki_ratio                    0.0    0.1 -0.1   0.0   0.1 
stim_devoicedTRUE:tokyo_kinki_ratio              0.0    0.1 -0.1   0.0   0.1 
dev_envTRUE:stim_devoicedTRUE:tokyo_kinki_ratio  0.1    0.1 -0.1   0.1   0.2 

とある。収束を示すRhatの値も1なので問題なく結果は収束している。

> MCMC diagnostics
                                                mcse Rhat n_eff
(Intercept)                                     0.0  1.0   3203
dev_envTRUE                                     0.0  1.0   4787
stim_devoicedTRUE                               0.0  1.0   4820
tokyo_kinki_ratio                               0.0  1.0   2641
dev_envTRUE:stim_devoicedTRUE                   0.0  1.0   4683
dev_envTRUE:tokyo_kinki_ratio                   0.0  1.0  16239
stim_devoicedTRUE:tokyo_kinki_ratio             0.0  1.0  17488
dev_envTRUE:stim_devoicedTRUE:tokyo_kinki_ratio 0.0  1.0  13963

各パラメタの事後分布で考えると、効果があるのはIntercept(4.9)、
dev_envTRUE(-0.4)、stim_devoicedTRUE(-0.8)、

>                                                          5%           95%
(Intercept)                                      4.610707698  5.113067e+00
dev_envTRUE                                     -0.648327103 -9.319705e-02
stim_devoicedTRUE                               -1.052349509 -5.087998e-01
tokyo_kinki_ratio                               -0.214697083  2.127467e-01
dev_envTRUE:stim_devoicedTRUE                    0.804916510  1.571824e+00
dev_envTRUE:tokyo_kinki_ratio                   -0.125624335  1.138492e-01
stim_devoicedTRUE:tokyo_kinki_ratio             -0.118278513  1.068271e-01
dev_envTRUE:stim_devoicedTRUE:tokyo_kinki_ratio -0.111683931  2.153518e-01
...
pars = c(
  ...
  "stim_devoicedTRUE",
  "tokyo_kinki_ratio",
  "dev_envTRUE:stim_devoicedTRUE",
  "dev_envTRUE:tokyo_kinki_ratio",
  "stim_devoicedTRUE:tokyo_kinki_ratio",
  "dev_envTRUE:stim_devoicedTRUE:tokyo_kinki_ratio"),
                   )
```
```{r}
library(bayesplot)

...
results_by_subject %>% 
  ...
  labs(title="Preference to Tokyo Pattern",
       x ="Tokyo--Kinki Ratio (Min/Max Scaled)",
       y = "Tokyo Preference")
ggsave(paste0("artifact/preference_by_tokyo_kinki_ratio_simple.png"), unit = "cm", width = 8, height = 8)
```
...
ggsave(paste0("artifact/preference_by_tokyo_kinki_ratio.png"), unit = "cm", width = 8, height = 8)
```
...
library(brms)
model_0 = brm(to_tokyo_pattern ~
               age + (1|subj_id) + (1|item_id),
               data=results_by_subject,
              save_all_pars = TRUE,
              iter=10000)

model_1 = brm(to_tokyo_pattern ~
               tokyo_kinki_ratio + (1|subj_id) + (1|item_id),
               data=results_by_subject,
              save_all_pars = TRUE,
              iter=10000)
...
# まぁtokyo_ratioかtokyo-kinki-ratioかなぁ
```
